...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon"
         href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSE8MPTRb0NSMWICvhgnnObXdThlT2BFXc8dleq-Amsm-8FSyghmkGziisTUb5Gmdhqcqo&usqp=CAU"
         type="image/x-icon" />
      <meta name="revisit-after" content="1 days" />
      <meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
      <title>@yield('title', 'Phim hay 2021 - Xem phim hay nhất')</title>
                   ...
                   <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                      ...
                      <li class="mega dropdown">
                         ...
                         <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a title="{{ $year }}" href="danhmuc.php">{{ $year }}</a>
                            </li>
                            @endforeach
                         </ul>
                      </li>
                      <li class="mega dropdown">
                         ...
                         <ul role="menu" class="dropdown-menu">
                            ...
                            <li>
                               <a title="{{ $category }}" href="danhmuc.php">{{ $category }} </a>
                            </li>
                            @endforeach
                         </ul>
                      </li>
                      <li class="mega dropdown">
                         ...
                         <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a title="{{ $country }}" href="danhmuc.php">{{ $country }}</a>
                            </li>
                            @endforeach
                         </ul>
                      </li>
